...
Процедура ПриОпределенииСправочниковДляЗагрузкиДанных(ЗагружаемыеСправочники) Экспорт
	...
	Если Ложь Тогда ЗагружаемыеСправочники = Новый ТаблицаЗначений; КонецЕсли;
	ЗагружаемыеСправочники.Очистить();
	
	Сведения = ЗагружаемыеСправочники.Добавить();
	Сведения.ПолноеИмя = Метаданные.Справочники.ДокументИсходящий.ПолноеИмя();
	Сведения.Представление = Метаданные.Справочники.ДокументИсходящий.Представление();
