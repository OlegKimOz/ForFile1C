...
//        * РегионСокращение - Строка - устаревшее свойство. Сокращение региона, например: "обл", если ДополнительныеПараметры.ПолноеНаименованиеСокращений = ЛОЖЬ,
//                                      или "область", если ДополнительныеПараметры.ПолноеНаименованиеСокращений = ИСТИНА.
...
//        * РайонТипПолный   - Строка - полное наименование типа района для адреса по административно-территориальному делению. Например: "район".
//        * РайонТипКраткий  - Строка - краткое наименование типа района для адреса по административно-территориальному делению. Например: "р-н".
//        * РайонСокращение  - Строка - устаревшее свойство. Сокращение района для адреса по административно-территориальному делению,
//                                      например: "р-н", если ДополнительныеПараметры.ПолноеНаименованиеСокращений = ЛОЖЬ,
//                                      или "район", если ДополнительныеПараметры.ПолноеНаименованиеСокращений = ИСТИНА.
//        * МуниципальныйРайон - Строка - текстовое представление муниципального района для адреса по муниципальному делению.
//        * МуниципальныйРайонТипПолный - Строка - полное наименование типа муниципального района по муниципальному делению. Например: "городской округ".
//        * МуниципальныйРайонТипКраткий - Строка - краткое наименование типа муниципального района для адреса по муниципальному делению. Например: "мун.р-н".
//        * МуниципальныйРайонСокращение - Строка - устаревшее свойство. Сокращение муниципального района для адреса по муниципальному делению, например: "мун.р-н",
//                                         если ДополнительныеПараметры.ПолноеНаименованиеСокращений = ЛОЖЬ,
//                                         или "муниципальный район", если ДополнительныеПараметры.ПолноеНаименованиеСокращений = ИСТИНА.
//        * КодМуниципальногоРайона - Число - код муниципального района: 1- муниципальный район; 2- городской округ; 3 - внутригородская территория города федерального значения.
...
//        * ПоселениеТипПолный  - Строка - полное наименование типа сельского поселения по муниципальному делению. Например: "сельское поселение".
...
//        * ПоселениеСокращение  - Строка - устаревшее свойство. Сокращение сельского поселения для адреса по муниципальному делению, например: "с. п.",
//                                         если ДополнительныеПараметры.ПолноеНаименованиеСокращений = ЛОЖЬ,
//                                         или "сельское поселение", если ДополнительныеПараметры.ПолноеНаименованиеСокращений = ИСТИНА
//        * КодПоселения       - Число - код поселения: 1 - городское поселение; 2 - сельское поселение; 3-  межселенная территория
...
//        * ВнутригородскойРайонСокращение - Строка - устаревшее свойство. Сокращение внутригородского района, например: "мкр",
//                                                    если ДополнительныеПараметры.ПолноеНаименованиеСокращений = ЛОЖЬ,
//                                                    или "микрорайон", если ДополнительныеПараметры.ПолноеНаименованиеСокращений = ИСТИНА
...
//                                               если ДополнительныеПараметры.ПолноеНаименованиеСокращений = ЛОЖЬ,
//                                               или "деревня", если ДополнительныеПараметры.ПолноеНаименованиеСокращений = ИСТИНА
...
//                                               если ДополнительныеПараметры.ПолноеНаименованиеСокращений = ЛОЖЬ,
//                                               или "Гаражно-строительный кооп.", если ДополнительныеПараметры.ПолноеНаименованиеСокращений = ИСТИНА
...
//        * ЭлементДополнительнойТерритории - Строка - устаревшее свойство. Текстовое представление элемента дополнительной территории.
//        * ЭлементДополнительнойТерриторииСокращение - Строка - устаревшее свойство. Сокращение элемента дополнительной территории.
...
//                                        Поле отсутствует, если дополнительный параметр КодыАдреса равен Ложь.
//        * ИдентификаторЗемельногоУчастка - УникальныйИдентификатор - Идентификационный код земельного участка адресного объекта. 
//                                       При отсутствии значения - пустая строка.
...
Функция ТипыОбъектовАдресацииАдресаРФ()
	...
	Результат.Добавить(СтрокаОбъектаАдресации("1034", НСтр("ru = 'Гараж'"),        1, 4, 4));
	Результат.Добавить(СтрокаОбъектаАдресации("1036", НСтр("ru = 'Здание'"),       1, 5, 5));
	Результат.Добавить(СтрокаОбъектаАдресации("1038", НСтр("ru = 'Шахта'"),        1, 6, 6));
