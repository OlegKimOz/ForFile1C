...
//                                    Если передана строка во внутреннем формате JSON, то возвращаемое значение будет полностью совпадать с ней.
...
//    ОжидаемыйВид - СправочникСсылка.ВидыКонтактнойИнформации, ПеречислениеСсылка.ТипыКонтактнойИнформации - используется для определения типа
//                   контактной информации, если его невозможно определить из переданной контактной информации в параметре КонтактнаяИнформация.
//
// Возвращаемое значение:
...
Функция ПараметрыВидаКонтактнойИнформации(ТипИлиВидКонтактнойИнформации = Неопределено) Экспорт
	...
	Иначе
		...
		ПараметрыВида = ОписаниеПараметровВидаКонтактнойИнформации(УстанавливаемыйТип);
	КонецЕсли;
...
Функция ОписаниеПараметровВидаКонтактнойИнформации(Знач УстанавливаемыйТип)
	...
	Если УстанавливаемыйТип = Перечисления.ТипыКонтактнойИнформации.Адрес Тогда
		...
		НастройкиПроверки.Вставить("ПроверятьПоФИАС",              Истина);
...
Функция ПараметрыИзВидаКонтактнойИнформации(Знач ВидКонтактнойИнформации)
	...
	ПараметрыВида = ОписаниеПараметровВидаКонтактнойИнформации(Тип);
