...
// Устарела. Следует использовать СтроковыеФункцииКлиентСервер.ПараметрыИзСтроки().
//
// Получает значения параметров из строки.
//
// Параметры:
...
Функция глФорматЧ(Число) Экспорт
	Возврат Формат(Число, "ЧДЦ=2; ЧРГ=' '; ЧН=-; ЧГ=3,0");	
КонецФункции // глФормат()
