...
Процедура ОбновитьИнформациюОВариантеОтчета()
	...
	|	ВариантыОтчетов.Представление КАК ВариантНаименование,
	...
	НастройкиОтчета.ВариантСсылка = Выборка.ВариантСсылка;
	НастройкиОтчета.КлючЗамеров = КлючЗамеров;
	НастройкиОтчета.ПредопределенныйСсылка = Выборка.ПредопределенныйСсылка;
	НастройкиОтчета.ИмяИсходногоВарианта = ?(Выборка.Пользовательский, Выборка.ИмяИсходногоВарианта, КлючТекущегоВарианта);
	НастройкиОтчета.Пользовательский = Выборка.Пользовательский;
	
	Если Не РежимРасшифровки Тогда 
		ОтчетНаименованиеТекущегоВарианта = Выборка.ВариантНаименование;
		ДополнительныеСвойства.ВариантНаименование = ОтчетНаименованиеТекущегоВарианта;
	КонецЕсли;
КонецПроцедуры
